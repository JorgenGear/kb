...
DROP POLICY IF EXISTS "Users can view their own repositories" ON repositories;
DROP POLICY IF EXISTS "Users can create repositories" ON repositories;
...
DROP POLICY IF EXISTS "Users can view documents in accessible repositories" ON documents;
DROP POLICY IF EXISTS "Users can create documents in their repositories" ON documents;
DROP POLICY IF EXISTS "Users can update documents in their repositories" ON documents;
DROP POLICY IF EXISTS "Users can delete documents in their repositories" ON documents;
DROP POLICY IF EXISTS "Users can view versions of accessible documents" ON versions;
DROP POLICY IF EXISTS "Users can create versions in their repositories" ON versions;
DROP POLICY IF EXISTS "Users can view branches of accessible repositories" ON branches;
DROP POLICY IF EXISTS "Users can create branches in their repositories" ON branches;
DROP POLICY IF EXISTS "Users can update branches in their repositories" ON branches;
DROP POLICY IF EXISTS "Users can delete branches in their repositories" ON branches;
